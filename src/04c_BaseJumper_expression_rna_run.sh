...
# bsub -q basement -M10000 -R 'span[hosts=1] select[mem>10000] rusage[mem=10000]' -J 04c_BaseJumper_expression_rna_symlink -o "log/%J_04c_BaseJumper_expression_rna_symlink.out" ". ~/.bashrc ; replace_symlinks out/BaseJumper/bj-expression/rna/PD63118_run/"