...
# rmarkdown::render('src/08d_vdj_coverage_knit.Rmd', output_file = 'VDJ_coverage.html', output_dir = 'out/vdj_coverage/')
...
plots <-
  system(paste0("ls ", wd,
                "/out/vdj_coverage/PD63118/*/plots/*_binned_cov.png"),
         intern = TRUE) %>%
  tibble::tibble(plot = .) %>%
