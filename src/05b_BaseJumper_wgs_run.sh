#!/bin/bash
# cd /lustre/scratch125/casm/team268im/at31/resolveome ; bsub -q week -M20000 -R 'span[hosts=1] select[mem>20000] rusage[mem=20000]' -J bj-wgs -o log/%J_bj-wgs.out -e log/%J_bj-wgs.err 'bash src/05b_BaseJumper_wgs_run.sh'
