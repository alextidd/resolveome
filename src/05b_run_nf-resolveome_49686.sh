#!/bin/bash
# cd /lustre/scratch125/casm/team268im/at31/resolveome ; bsub -q long -M2000 -R 'span[hosts=1] select[mem>2000] rusage[mem=2000]' -J resolveome_49686 -o log/resolveome_49686_%J.out -e log/resolveome_49686_%J.err 'bash src/05b_run_nf-resolveome_49686.sh'
